...
private:
        ...
        timerMsg *channelTimer;             // add here, update channel state
        chTimer *channelsArray;            // Keeps record of total channels in the RF spectrum and their results
    ...
    protected:
        ...
        void trackChannel(double startTime);
};
